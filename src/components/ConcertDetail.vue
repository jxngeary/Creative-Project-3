...
// 	add_to_cart(product) {
// 
// 		let current_index = this.$root.$data.cart.indexOf(product.product);
// 		debugger;
// 		console.log("current_index:" + current_index);
// 
// 		if (current_index >= 0 )
// 		{
// 			console.log("it's there. incrementing this value:");
// 			console.log(this.$root.$data.cart[current_index].quantity);
// 			this.$root.$data.cart[current_index].quantity += 1;
// 		}
// 		else
// 		{
// 			product.product.quantity = 1;
// 			this.$root.$data.cart.push(product.product);
// 		}
// 	}
  }
}
